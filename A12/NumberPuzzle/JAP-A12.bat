...
SET SECONDCLASSSRC=src/game/NewGameWindow.java
SET IMAGESOURCE=src\game\images
SET IMAGEDESTINATION=bin\game\images
...
mkdir images
cd ..\..
:: Copying images from src to bin
robocopy %IMAGESOURCE% %IMAGEDESTINATION%
