...
public class GameModel 
{
	...
	/** The players results from the last game */
	private String results = "";

	/**
	 * Accessor for the players results
	 * @return The players most recent result
	 */
	...
	/**
	 * Mutator for the players results
	 * @param results The players most recent result
	 */
